...
**报告生成时间**: 2025-12-02 17:20:11
**结果文件**: fio-results_20251202_171237.json
**输出目录**: /home/ubuntu/intel-4610-hdd/rbd0/20251202_171237
**测试文件**: /dev/rbd0
...
|-------|---------|---------|----------------|----------------|---------------|---------------|---------------|---------------|
| RND-RW-4K-70-30-PROD | 6,615 | 2,841 | 25.84 | 11.10 | 4.60 | 34.36 | 0.00 | 0.00 |
...
|-------|------|-------------|-------------|-------------|----------------|---------------|
| LATENCY-RND-READ-4K | 1,202 | 4.70 | 0.83 | 0.00 | 0.00 | 3.31 |
...
| 作业名 | IOPS | 吞吐量 (MB/s) | 平均延迟 (ms) | P99 延迟 (ms) | P99.99 延迟 (ms) | 延迟标准差 (ms) |
|-------|------|-------------|-------------|-------------|----------------|---------------|
| LATENCY-RND-WRITE-4K | 519 | 2.03 | 1.92 | 0.00 | 0.00 | 12.28 |
